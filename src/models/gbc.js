 ...
 */
GbcSchema.methods.increaseViews = function() {
    let doc = this;
    doc.update({
            $inc: {
                views: 1
 ...
 */
GbcSchema.statics.topPlayed = function() {
 ...
 */
GbcSchema.pre('save', function(next) {
    var doc = this;
...
const Gbc = mongoose.model('gbc', GbcSchema);
module.exports = Gbc;
